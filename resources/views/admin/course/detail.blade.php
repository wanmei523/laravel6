...
<div class="row mt-2 mb-2">
    <div class="col-12">
        <div class="d-flex mb-2">
            ...
            <a onclick='return confirm("确认删除吗?")' href="{{route('admin.course.chapter.remove',[$course->id,$chapter->id])}}" class="btn btn-danger btn-sm mb-1 mr-1">移除</a>
        </div>
    </div>
    <div class="col-12">
